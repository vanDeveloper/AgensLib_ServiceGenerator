...
public interface BlackboardInterface {
	void writeTask(BlackboardTask task);
	boolean removeTask(int id);
	BlackboardTask getTask(BlackboardRole role);
	BlackboardTask getTaskInProcess(BlackboardRole role);
	BlackboardTaskState getTaskState(BlackboardTask task);
}
